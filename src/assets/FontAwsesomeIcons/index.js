...
import { faUser, faUserGraduate, 
    ...
    faCircleExclamation,faCircleCheck,faCircleXmark,
    faArrowDown,faShareNodes} from "@fortawesome/free-solid-svg-icons";

library.add(faUserGraduate, faChalkboardTeacher, 
    faPen, faTrash,faArrowUpFromBracket,faQuestionCircle,
    faCircleExclamation,faUser,faCircleCheck,faCircleXmark,faArrowDown,faShareNodes)